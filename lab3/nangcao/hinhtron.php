...
<body>
    ...
    {
        if($_POST['bankinh']!="" && $_POST['bankinh']>=0)
        {
            ...
            <div>
                ...
                <div class='form-outline'>
                    <div style="margin-left:20px;" class="flex-doc">
                        ...
                        <input class="form-in" type="number" name="bankinh" <?php if(isset($_POST['bankinh'])) echo "value='$bankinh'" ?>  placeholder="Nhập bán kinh" required />
                    </div>
                </div>
