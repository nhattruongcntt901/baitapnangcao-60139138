...
<div class='container flex-ngang'>
    <form name='them_nv' class='w-75 form-outline-black' onsubmit="return submit_them_nhanvien()" method="post" enctype="multipart/form-data" style='padding:20px'>
        <div class="row no-gutters">
            <div class='col-md-6'>
                <div class="form-outline-black flex-doc">
                    ...
                    <input class='font-lato-heavy color-black w-100' type="text" id='ho_nv' name='ho_nv'
            ...
            <div class='col-md-6'>
                <div class="form-outline-black flex-doc">
                    ...
                    <input class='font-lato-heavy color-black w-100' type="text" id='ten_nv' name='ten_nv'
        ...
        <div class="row no-gutters">
            <div class='col-md-6'>
                <div class="form-outline-black flex-doc">
                    ...
                    <input class='font-lato-heavy color-black w-100' type="text" id='ngaysinh_nv' name='ngaysinh_nv'
                        placeholder="Ngày sinh của bạn..." onfocus="(this.type='date')" required />
                </div>
            </div>
            <div class='col-md-6'>
                <div class="form-outline-black flex-doc">
                    <span class="material-icons-outlined color-black">wc</span>
                    <select class='font-lato-heavy color-black form-select w-100' id='gioitinh_nv' name='gioitinh_nv'
                        required>
        ...
        <div class="row no-gutters">
            <div class='col-md-6'>
                <div class="form-outline-black flex-doc">
                    ...
                    <input class='font-lato-heavy color-black w-100' type="text" id='diachi_nv' name='diachi_nv'
            ...
            <div class='col-md-6'>
                <div class="form-outline-black flex-doc">
                    ...
                    <input class='font-lato-heavy color-black' type="file" id='upload_anh' name='upload_anh'
                        placeholder="Ảnh đại diện của bạn..." accept="image/png, image/jpeg, image/jpg" required />
                </div>
            </div>
        </div>
        <div class="row no-gutters">
            ...
            <div class='col-md-6'>
                <div class="form-outline-black flex-doc">
                    ...
                    <select class='font-lato-heavy color-black form-select w-100' id='phongban_nv' name='phongban_nv'
                        required>
        ...
        <div>
            ...
            <button class='w-100 btn' onclick="open_thongbao()" style='background-color:rgb(117, 114, 179);color:white'
                type='submit'>Thêm nhân
                viên</button>
        </div>
        ...
        <form class='form-outline-black' style='padding:20px' onsubmit="return submit_them_loainhanvien()">
            <div class="row no-gutters">
                <div class='col-md-12'>
                    <div class="form-outline-black flex-doc">
                        <span class="material-icons-outlined color-black">badge</span>
                        <input class='font-lato-heavy color-black w-100' type="text" id='tenloai' name='tenloai'
                            placeholder="Nhập tên loại nhân viên..." required />
                    </div>
                </div>
            </div>
            <div>
                <button class='w-100 btn' style='background-color:rgb(117, 114, 179);color:white'
                    type='submit'>Thêm loại nhân viên</button>
            </div>
        </form>
    </div>
</div>
        ...
        <form class='form-outline-black' style='padding:20px' onsubmit="return submit_them_phongban()">
            <div class="row no-gutters">
                <div class='col-md-12'>
                    <div class="form-outline-black flex-doc">
                        <span class="material-icons-outlined color-black">badge</span>
                        <input class='font-lato-heavy color-black w-100' type="text" id='phongbannv' name='phongbannv'
            ...
            <div>
                <button class='w-100 btn' style='background-color:rgb(117, 114, 179);color:white'
                    type='submit'>Thêm phòng ban</button>
            </div>
        </form>
    </div>
</div>
