    ...
    <div class='container'>
        ...
        <div class='flex-ngang'>
            <?php if ($page_hientai != 1) { ?>
                <!-- Trang đầu -->
                <a style='padding:10px;<?php echo "color:blue"; ?>' href="http://localhost/baitap/lab6/nangcao/nhanvien/page/danhsach_nv.php?page=1">Trang Đầu</a>
                <!-- Trang trước -->

                <a style='padding:10px;<?php echo "color:blue"; ?>' href="http://localhost/baitap/lab6/nangcao/nhanvien/page/danhsach_nv.php?page=<?php echo $page_hientai - 1; ?>">Trang Trước</a>
            <?php } ?>
            ...
            ?>
                <a style='padding:10px;<?php if ($i == $_GET['page']) {
                                            echo "color:red";
                                        }else echo "color:blue"; ?>' href="http://localhost/baitap/lab6/nangcao/nhanvien/page/danhsach_nv.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
            <?php
            }
            ?>
            ...
            <?php if ($page_hientai != $page) { ?>
                <a style='padding:10px;<?php echo "color:blue"; ?>' href="http://localhost/baitap/lab6/nangcao/nhanvien/page/danhsach_nv.php?page=<?php echo $page_hientai + 1; ?>">Trang Sau</a>


                <!-- Trang cuối    -->
                <a style='padding:10px;<?php echo "color:blue";?>' href="http://localhost/baitap/lab6/nangcao/nhanvien/page/danhsach_nv.php?page=<?php echo $page; ?>">Trang Cuối</a>
            <?php } ?>
        </div>
    </div>
</div>
